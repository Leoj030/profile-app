...
export default async function LoginPage() {
    ...
    return (
        <div className="min-h-screen bg-[#1a2340] text-slate-300 font-sans flex items-center justify-center p-6 relative overflow-hidden">
            {/* Background Glow */}
            ...
            <div className="w-full max-w-md relative z-10">
                <div className="backdrop-blur-xl bg-slate-800/50 border border-slate-700/60 rounded-3xl p-8 sm:p-12 shadow-2xl flex flex-col items-center">
                    {/* Logo/Icon */}
